...
- [ ] [[src/lib.rs:0] - Remove this from this module and add it to `EcdpSetrLoans` module.](/modules/ecdp-loans/src/lib.rs): Add `OnLoanUpdate` to [EcdpSetrLoans Module](/modules/ecdp-setr-loans/).
