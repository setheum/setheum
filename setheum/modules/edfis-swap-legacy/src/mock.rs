...
//! Mocks for the edfis_swap_legacy module.
...
pub type USSDJointSwap = SpecificJointsSwap<EdfisSwapLegacyModule, USSDJoint>;
pub type SEEJointSwap = SpecificJointsSwap<EdfisSwapLegacyModule, SEEJoint>;
...
construct_runtime!(
	pub enum Runtime {
		System: frame_system,
		EdfisSwapLegacyModule: edfis_swap_legacy,
		Tokens: orml_tokens,
	}
);
...
impl ExtBuilder {
	...
	pub fn build(self) -> sp_io::TestExternalities {
		...
		edfis_swap_legacy::GenesisConfig::<Runtime> {
