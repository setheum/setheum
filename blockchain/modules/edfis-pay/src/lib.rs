...
//!This module allows users to create secure reversible payments that keep
...
//!   disputed.
//! - Remark: The module allows to create payments by optionally providing some
...
//! "payment" on Setheum Pay is similar to an escrow, it is used to guarantee
