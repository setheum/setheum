...
- **Core Blockchain & Runtime**: Licensed under the [GNU GPL Version 3](./docs/LICENSES/LICENSE-GPL3.md) (GPL-3.0-or-later WITH Classpath-exception-2.0). This includes the `repos/setheum/` node, runtime, and all the remaining code, except explicitly stated here or in a `LICENSE.md`.
