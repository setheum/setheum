...
Usage:
  $0
  This script allows you to run setheum-node within docker and simulate some custom network conditions, e.g. delays, rate limit,
  ...
  IMPORTANT: this script requires setheum-node:latest docker image.
    --no-build-image
