...
log "building docker image for setheum-node that supports synthetic-network"
docker build --tag setheum-node:syntheticnet --file docker/Dockerfile.synthetic_network .
