...
def get_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="""
Script for maintenance operations on SetheumNode chain with regards to pallet balances.
...
By default, it connects to a Setheum Testnet and performs read-only state logic checks.
...
""",
    ...
    parser.add_argument('--fix-consumers-counter',
                        ...
                        help='Specify this switch if script should fix any consumers counter discrepancy found.'
                             ...
                             '--fix-accounts-in-batch accounts. It requires SetheumNode >= 14.0'
                             'Default: False')
