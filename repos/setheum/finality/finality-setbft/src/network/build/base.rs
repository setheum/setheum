...
fn spawn_state_request_handler<B: Block, BE: Backend<B>, C: ClientForSetBFT<B, BE>>(
...
fn spawn_light_client_request_handler<B: Block, BE: Backend<B>, C: ClientForSetBFT<B, BE>>(
    full_network_config: &mut FullNetworkConfiguration,
    protocol_id: &ProtocolId,
    client: Arc<C>,
    spawn_handle: &SpawnTaskHandle,
