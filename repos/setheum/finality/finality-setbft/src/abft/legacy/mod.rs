...
use legacy_set_bft::{create_config, default_delay_config, Config, LocalIO, Terminator};
use log::debug;
...
pub use crate::setbft_primitives::LEGACY_FINALITY_VERSION as VERSION;
use crate::{
    abft::{
...
type WrappedNetwork<H, ADN> = NetworkWrapper<
    legacy_set_bft::NetworkData<Hasher, SetBFTData<H>, Signature, SignatureSet<Signature>>,
    ADN,
>;
pub fn run_member<H, C, ADN, V>(
    ...
    data_provider: impl legacy_set_bft::DataProvider<SetBFTData<H::Unverified>> + 'static,
