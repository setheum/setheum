...
2. Set `setheum-client` in `Cargo.toml` to point to commit sha which your local `setheum-node` was built from. E.g. below builds `setheum-client` based on `r-13.4` version:
```
setheum_client = { git = "https://github.com/Cardinal-Cryptography/setheum-node", rev = "b072940af9b7295a141a89b943a29a74bb21c9f8" }
```
3. Run 
``` 
