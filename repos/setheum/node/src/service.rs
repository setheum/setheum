...
use finality_setbft::{
    build_network, get_setheum_block_import, run_validator_node, SetheumNodeConfig, BlockImporter,
...
pub fn new_authority(
    ...
    service_components
        .task_manager
        .spawn_essential_handle()
        .spawn_blocking("setheum", None, run_validator_node(setheum_config));
