...
- [ ] [[src/lib.rs:0] - Remove this from this module and add it to `SetrLoans` module.](/modules/loans/src/lib.rs): Add `OnLoanUpdate` to [SetrLoans Module](/modules/setr-loans/).
