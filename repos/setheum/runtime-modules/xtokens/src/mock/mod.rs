...
pub type ParaTokens = module_tokens::Pallet<para::Runtime>;
pub type ParaXTokens = module_xtokens::Pallet<para::Runtime>;
pub type AssetHubBalances = pallet_balances::Pallet<asset_hub::Runtime>;

pub type ParaRelativeTokens = module_tokens::Pallet<para_relative_view::Runtime>;
pub type ParaRelativeXTokens = module_xtokens::Pallet<para_relative_view::Runtime>;

pub type ParaTeleportTokens = module_tokens::Pallet<para_teleport::Runtime>;
