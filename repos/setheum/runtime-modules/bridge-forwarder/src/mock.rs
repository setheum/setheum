...
use module_bridge_traits::{AssetTypeIdentifier, Bridge, TransactorForwarder};
use xcm::v3::Weight;
use xcm_builder::{
...
use crate as module_bridge_forwarder;
...
construct_runtime!(
	pub struct Runtime{
		...
		BridgeForwarder: module_bridge_forwarder::{Pallet, Event<T>},
...
impl module_bridge_forwarder::Config for Runtime {
	type RuntimeEvent = RuntimeEvent;
	type Bridge = BridgeImplRuntime<Runtime>;
