...
Provides an Emergency Shutdown protocol for Stablecoin on Ethical DeFi. When a black swan occurs such as price plunge or fatal bug, the highest priority is to minimize user losses as much as possible. 

The Emergency Shutdown Module enables three types of Emergency Shutdown's which are:
- Setheum USD Emergency Shutdown: To Shutdown the Setheum USD (SEUSD) Stablecoin System.
