...
parameter_types! {
	...
	pub UniversalLocation: InteriorLocation = X1(GlobalConsensus(RococoNetwork::get()));
}
...
parameter_types! {
	pub Rococo: AssetFilter = Wild(AllOf { fun: WildFungible, id: Concrete(RooLocation::get()) });
