...
use frame_election_provider_support::{data_provider, DataProviderBounds, ElectionDataProvider, VoteWeight};
use frame_support::{
...
impl ElectionDataProvider for StakingMock {
	...
	fn electable_targets(_maybe_max_len: DataProviderBounds) -> data_provider::Result<Vec<AccountId>> {
...
impl TestExtBuilder {
	pub fn new(reserved_validators: Vec<AccountId>, non_reserved_validators: Vec<AccountId>) -> Self {
		Self {
			committee_seats: CommitteeSeats {
