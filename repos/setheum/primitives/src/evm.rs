...
/// Setheum Mainnet 258
pub const CHAIN_ID_SETHEUM_MAINNET: u64 = 787u64;
/// Setheum Damascus Testnet 2580
pub const CHAIN_ID_DAMASCUS_TESTNET: u64 = 597u64;
/// Qingdao Devnet 2581
pub const CHAIN_ID_QINGDAO_DEVNET: u64 = 595u64;
...
///                                                             3-ForeignAsset(ignore Erc20, without the prefix of system contracts)
...
///                                                             0-Token 1-Erc20 2-ForeignAsset
...
///                                   ^^^^^^^^ CurrencyId Type is 3-ForeignAsset, ForeignAssetId
