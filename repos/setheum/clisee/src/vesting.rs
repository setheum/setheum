...
pub async fn vested_transfer(
	...
	let schedule = VestingInfo { locked: amount_in_tokens as Balance * TOKEN, per_block, starting_block };
	match connection.vested_transfer(receiver, schedule, TxStatus::Finalized).await {
