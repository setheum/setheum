...
use primitives::{
    ...
    AccountId, SetheumNodeSessionKeys, Version as FinalityVersion, ADDRESSES_ENCODING,
    TOKEN_DECIMALS,
};
...
pub fn build_chain_spec(
    ...
    Ok(SetheumChainSpec::builder(
        WASM_BINARY.ok_or("Setheum development wasm not available")?,
        Default::default(),
    )
