...
use primitives::{AccountId, Version as FinalityVersion, CURRENT_FINALITY_VERSION, LEGACY_FINALITY_VERSION};
...
pub struct ChainSpecParams {
	...
	/// Chain name. Default is "Setheum Development"
	#[arg(long, default_value = "Setheum Development")]
	chain_name: String,

	/// Token symbol. Default is SEU
	#[arg(long, default_value = "SEU")]
	token_symbol: String,
