...
pub use sheyth_vm_common::program::{ProgramBlob, ProgramParseError, ProgramParts};

pub static TARGET_JSON_32_BIT_OLD: &str = include_str!("../targets/legacy/riscv32emac-unknown-none-sheyth_vm.json");
pub static TARGET_JSON_64_BIT_OLD: &str = include_str!("../targets/legacy/riscv64emac-unknown-none-sheyth_vm.json");

pub static TARGET_JSON_32_BIT_NEW: &str = include_str!("../targets/1_91/riscv32emac-unknown-none-sheyth_vm.json");
pub static TARGET_JSON_64_BIT_NEW: &str = include_str!("../targets/1_91/riscv64emac-unknown-none-sheyth_vm.json");
...
pub fn target_json_path(args: TargetJsonArgs) -> Result<PathBuf, String> {
    if args.is_64_bit {
        target_json_path_impl(
            "riscv64emac-unknown-none-sheyth_vm.json",
        ...
        target_json_path_impl(
            "riscv32emac-unknown-none-sheyth_vm.json",
