...
use alloc::sync::Arc;
use sheyth_vm_assembler::Assembler;
...
impl ModuleConfig {
    ...
    pub(crate) fn hash(&self, cost_model: &CostModelKind) -> Option<sheyth_vm_common::hasher::Hash> {
        ...
        let mut hasher = sheyth_vm_common::hasher::Hasher::new();
