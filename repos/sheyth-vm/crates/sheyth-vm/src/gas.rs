use alloc::sync::Arc;
use alloc::vec::Vec;
use sheyth_vm_common::program::{InstructionSet, InstructionVisitor, Instructions, Opcode, ParsingVisitor, RawReg};
use sheyth_vm_common::simulator::CacheModel;
...
sheyth_vm_common::impl_parsing_visitor_for_instruction_visitor!(GasVisitor);
