...
pub fn sheyth_vm_export(attributes: ExportBlockAttributes, input: syn::ItemFn) -> Result<proc_macro2::TokenStream, syn::Error> {
    ...
    let section_name = syn::LitStr::new(&format!(".text.sheyth_vm_export.{}", ident), ident.span());
    ...
    Ok(quote! {
        ...
        #vis #unsafety fn #ident(#args) #output {
            ...
            mod __sheyth_vm_export {
                ...
                #[link_section = ".sheyth_vm_metadata"]
                ...
                ::core::arch::global_asm!(
                    ".pushsection .sheyth_vm_exports,\"Ra\",@note\n",
                    ".byte 1\n", // Version.
