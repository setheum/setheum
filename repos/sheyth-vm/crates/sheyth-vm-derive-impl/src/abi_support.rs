...
pub fn sheyth_vm_impl_abi_support(attributes: AbiSupportAttributes) -> proc_macro2::TokenStream {
    ...
    assert!(maximum_input_regs as usize <= sheyth_vm_common::program::Reg::MAXIMUM_INPUT_REGS);
    quote! {
        #common_public_code
