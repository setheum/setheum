...
pub fn sheyth_vm_define_abi(attributes: AbiSupportAttributes, input: syn::ItemMod) -> Result<proc_macro2::TokenStream, syn::Error> {
    ...
    let support_code = crate::abi_support::sheyth_vm_impl_abi_support(attributes);
