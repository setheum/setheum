...
Different parts of this monorepo are licensed differently (GPLv3, Apache 2.0, or MIT). See [LICENSES](./LICENSE.md) for the full breakdown of which license applies to each project.
